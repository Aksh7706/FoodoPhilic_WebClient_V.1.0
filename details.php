        ...
        <div class="container">
            ...
            <div class="col-md-9">
                ...
                <div class="row" id="productMain">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="box">
                            ...
                            <h1 class="text-center" style="margin-bottom: 30px"> <?php echo $pro_title; ?> </h1>
                            ...
                            <form action="details.php?add_cart=<?php echo $product_id; ?>" method="post" class="form-horizontal">
                                ...
                                <div class="form-group" style="margin-right: 40px">
                                    ...
                                    <div class="col-md-7">
                                        ...
                                        <select name="product_qty" style="font-size: 18px" class="form-control">
                ...
                <div id="row same-height-row">
                    ...
                    <div class="col-md-3 col-sm-6" style="padding-left:0;padding-right:0">
...
<div class='center-responsive col-md-3 col-sm-6' style='padding-left:30px;padding-right:0px;'>

<div class='product same-height' >

<a href='details.php?pro_id=$pro_id' >

<img src='admin_area/product_images/$pro_img1' class='img-responsive' style='height: 295px; width:100%'>  
