...
<body class="demo-3">
    <div class="container">
        ...
        <div class="intro">
            <h2 class="intro__title">Foodo' Philic</h2>
            <p class="intro__subtitle">A master class with Michelin star chef Haris Katut</p>
            <button class="intro__button"><a href="../index.php">Order now</a></button>
        </div>
    </div>
    <!-- /container -->
