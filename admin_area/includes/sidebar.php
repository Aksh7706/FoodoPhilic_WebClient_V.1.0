        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu">
                ...
                <li>
                    ...
                    <a href="index.php?view_employes">

                        <i class="fa fa-fw fa-gear"></i> Employes

                        <span class="badge"><?php echo $count_employes; ?></span>
    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse">
        ...
        <ul class="nav navbar-nav side-nav">
            ...
            <li>
                ...
                <a href="#" data-toggle="collapse" data-target="#inventory">

                    <i class="fa fa-fw fa-table"></i> Inventory
                ...
                <ul id="inventory" class="collapse">
                    ...
                    <li>
                        <a href="index.php?insert_inv"> Insert Item </a>
                    </li>

                    <li>
                        <a href="index.php?view_inv"> View Inventory </a>
                    </li>
            ...
            <li>
                ...
                <a href="#" data-toggle="collapse" data-target="#emp">
                    ...
                    <i class="fa fa-fw fa-edit"></i> Employes
                ...
                <ul id="emp" class="collapse">
                    ...
                    <li>
                        <a href="index.php?insert_employe"> Insert Employe </a>
                    </li>
